Este repositório contém uma aplicação front-end simples desenvolvida com HTML, CSS e JavaScript. Ele tem como objetivo exercitar a manipulação de arrays em JavaScript de forma interativa e visual.
